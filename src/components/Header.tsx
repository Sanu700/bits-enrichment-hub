  ...
  return (
    <header
      className={`fixed top-0 z-50 w-full transition-all duration-700 ${
        scrolled
          ? "shadow-[0_8px_32px_-8px_hsl(var(--amber)/0.45)] border-b border-amber-light/40"
          : "shadow-[0_4px_20px_-8px_hsl(var(--amber)/0.40)] border-b border-amber-light/30"
      }`}
      style={{
        background: `linear-gradient(to right, hsl(var(--amber)), hsl(var(--amber-light)))`,
      }}
    >
      <div className="absolute inset-x-0 -bottom-4 h-4 bg-gradient-to-b from-amber-light/30 to-transparent pointer-events-none" />
